...
(() =>{
    ...
    //attech an event handler to document
    document.addEventListener("click",(event) =>{
        if(event.target.classList.contains('link-item')){
            ...
            if(event.target.hash !==""){
                ...
                /*if ckicked 'link-item is contained withing the navegation menu'*/
...
function popupSlideshow(){
    ...
    //activate the loader untill the popupImg loaded
